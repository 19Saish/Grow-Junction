...
import { deleteWorkshop } from '../../../../../src/graphql/mutations'
import { updateWorkshop } from '../../../../../src/graphql/mutations'
...
const Workshop = ({ services }) => {
  ...
  const findPost = async (id) => {
    ...
    try {
      ...
      console.log(workshopResult.data.getWorkshop)
  ...
  const editPost = async (id) => {
    ...
    try {
      ...
      if (workshop.file) {
        ...
        await setS3FileUrl(filename, workshop.file, workshop.workshopImage)
